@extends("administration.includes.main",["title" => "Gestion des Speakers"])
@section("content")
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Liste des speakers </h5>

                <div class="card-text mt-3">
                    <div class="offset-sm-10 col-sm-2 mb-5">  <a href="{{route("admin.speakers.create") }}"
